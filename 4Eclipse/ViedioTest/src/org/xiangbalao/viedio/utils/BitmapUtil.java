package org.xiangbalao.viedio.utils;
...
public class BitmapUtil {
	...
	public static String saveBitmap(Bitmap bitmap, String photoFile) {
	...
	public static Bitmap rotateBitMap(Bitmap bp, String imgpath, int ori) {
		int digree = 0;
